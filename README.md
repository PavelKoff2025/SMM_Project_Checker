...
- Извлечение текста через pdfplumber / PyPDF2 + OCR fallback (poppler + Tesseract) / python-pptx
...
- **Рейтинг проектов** — все проверенные работы, отсортированные по оценке (от 10 до 0), с местами и медалями 🥇🥈🥉
- **Поиск проектов** — мгновенный поиск по названию среди всех завершённых проверок
- OCR fallback для PDF без текстового слоя (сканы, бледный текст, скриншоты слайдов)
